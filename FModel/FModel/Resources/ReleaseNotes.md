...
- 新エクスプローラーの UI を本家 FModel に近いカード型タイル表示へ刷新しました。検索欄を横幅いっぱいに広げ、右側にクラス絞り込みを配置し、フォルダーとファイルを見分けやすいカードで表示します。
- フォルダーアイコンを金色の立体的なデザインへ改善し、`Config` には歯車、`Plugins` にはパズルのバッジを表示するようにしました。
