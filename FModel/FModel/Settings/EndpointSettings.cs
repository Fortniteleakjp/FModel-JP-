        ...
        switch (gameName)
        {
            ...
            case "Fortnite [LIVE]":
                return new EndpointSettings[]
                {
                    ...
                    new("https://uedb.dev/svc/api/v1/fortnite/mappings", "$.mappings.ZStandard") // just get the first available, not just oodle! (Unfortunately not default except when resetting settings)
                };
            default:
